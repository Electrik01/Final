    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.Feature_Id, t.Game_Id })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Pictures", "Game_Id", "dbo.Games");
            ...
            DropForeignKey("dbo.FeatureGames", "Game_Id", "dbo.Games");
            DropForeignKey("dbo.FeatureGames", "Feature_Id", "dbo.Features");
            ...
            DropIndex("dbo.FeatureGames", new[] { "Game_Id" });
            DropIndex("dbo.FeatureGames", new[] { "Feature_Id" });
